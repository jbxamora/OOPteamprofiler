// Variables
const Manager = require("./staff/Manager.js").default;
const Engineer = require("./staff/Engineer.js").default;
const Intern = require("./staff/Intern.js").default;
// Dependencies
...
const generateTeam = require("./outpath/template").default;
...
function runApp() {
    ...
    // Function to double check if user is done adding team members or would like to add another
    function AddAnother() {
        inquirer
            .prompt([
                {
